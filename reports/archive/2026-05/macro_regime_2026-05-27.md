...
## 1. 현재 레짐
현재 레짐: Inflation Rebound + Dollar/KRW Risk
보조 레짐: Liquidity Bubble
한 줄 요약: 인플레와 환율 부담이 남아 있어 공격적 위험자산 확대보다는 방어적 대기와 헤지 유지가 더 자연스러운 조합입니다.

## 2. 핵심 판단
- Inflation Risk 6.0/10, FX Risk 6.5/10로 물가·환율 방어 논리가 우세합니다.
- Credit Stress Risk 1.5/10로 급성 신용위기 신호는 아직 제한적이지만, 성장 둔화 점수는 3.8/10입니다.
...
### 인플레
판단: 중간 이상 리스크
근거: 미국 CPI YoY 3.78%, Core CPI YoY 2.74%, Core PCE YoY 3.2%, 한국 CPI YoY 2.57%, WTI 112.25 (2026-05-18).
자산 영향: 금은 인플레·정책실수 헤지 역할이 커지고, 주식/ETF는 밸류에이션 부담을 함께 점검해야 합니다.
최신성: US CPI: ok, 56d / US Core CPI: ok, 56d / US Core PCE: ok, 87d / Korea CPI: ok, 56d / WTI: ok, 9d

### 금리
판단: 인하 기대와 고금리 유지 부담이 공존
근거: Fed 기준금리 3.62 (2026-05-27), 한국은행 기준금리 2.5 (2026-05-27), 미국 10년물 4.56 (2026-05-22), 미국 10Y-2Y 금리차 0.49 (2026-05-26).
자산 영향: 단기채/현금성 자산의 방어 역할은 유지되며, 장기채와 성장주는 금리 재상승에 취약할 수 있습니다.
최신성: Fed policy: ok, 0d / BOK base: ok, 0d / US 10Y: ok, 5d / US 10Y-2Y: ok, 1d

### M2/유동성
판단: 중간 이상 수준의 유동성·위험선호
근거: 미국 M2 YoY 4.72%, 미국 M2 3M 1.67%, 한국 M2 YoY 5.56%, NFCI -0.52 (2026-05-15).
자산 영향: 유동성은 위험자산을 지지할 수 있지만, 버블 리스크가 커지면 현금 보유의 옵션 가치도 커집니다.
최신성: US M2: ok, 56d / Korea M2: ok, 87d / NFCI: ok, 12d

### 신용스프레드
판단: 낮음 리스크
근거: 하이일드 스프레드 2.74 (2026-05-25), BBB 스프레드 0.93 (2026-05-25), 금융시장 스트레스 -0.74 (2026-05-15), 은행 대출태도 8.1 (2026-04-01), 기업대출 연체율 프록시 1.34 (2026-01-01).
자산 영향: 신용 스트레스가 낮을 때는 주식 급감 리스크가 제한되지만, 스프레드 확대 전환 시 현금 비중의 방어성이 커집니다.
최신성: HY spread: ok, 2d / BBB spread: ok, 2d / Financial stress: ok, 12d / Lending standards: ok, 56d / Delinquency proxy: ok, 146d

### 환율
판단: 중간 이상 리스크
근거: USD/KRW 1504.3 (2026-05-26), DXY 99.09 (2026-05-27), 한미 기준금리차 1.12 (2026-05-27), 경상수지 37327.1 (2026-03-01), 무역수지 26238.74 (2026-03-01), 외국인 주식/채권 흐름 -29326.9 (2026-03-01) / -4715.9 (2026-03-01).
자산 영향: 원화 약세 리스크가 높을수록 금과 달러 노출 자산의 헤지 성격이 강화됩니다.
최신성: USD/KRW: ok, 1d / DXY: ok, 0d / US-Korea gap: ok, 0d / Current account: ok, 87d / Trade balance: ok, 87d / Foreign stock flows: ok, 87d / Foreign bond flows: ok, 87d

### 고용
판단: 중간 성장 둔화 리스크
근거: 미국 실업률 4.3 (2026-04-01), 비농업고용 월간 변화 115천명, 신규 실업수당 청구 209000 (2026-05-16), 임금 YoY 3.57%.
자산 영향: 고용이 급격히 꺾이지 않으면 주식의 성장 엔진은 유지되지만, 둔화가 확인되면 현금성 자산 비중을 낮추기 어렵습니다.
최신성: US unemployment: ok, 56d / Payrolls: ok, 56d / Jobless claims: ok, 11d / Hourly earnings: ok, 56d

### 이상기후/원자재
판단: 중간 이상 공급충격 리스크
근거: WTI 112.25 (2026-05-18), 천연가스 3M 3.02%, 밀 3M 18.08%, 비료 3M 11.23%, GDACS 주황/적색 이벤트 0 (2026-05-27).
자산 영향: 에너지·식품 충격 가능성이 남아 있으면 금/은과 일부 원자재 헤지의 방어 논리가 유지됩니다.
최신성: WTI: ok, 9d / Natural gas: ok, 9d / Wheat: ok, 0d / Fertilizer: ok, 56d / GDACS non-green: ok, 0d

## 4. Risk Score
| 항목 | 점수 | 전회 대비 | 산정 방식 | 해석 |
|---|---:|---:|---|---|
| Inflation Risk | 6.0/10 | 이전 기록 없음 | CPI/Core CPI/PCE/Core PCE/Korea CPI/5Y breakeven/WTI threshold scores, simple average | 중간 이상: 미국 물가와 유가 레벨이 아직 2% 목표 복귀보다 재상승 경계를 요구 |
| Liquidity Bubble Risk | 6.2/10 | 이전 기록 없음 | US M2 YoY, US M2 3M, Korea M2 YoY, Fed reserve balances 3M, NFCI, and DXY risk-appetite proxy | 중간 이상: M2와 금융여건 완화가 위험선호를 지지하지만 버블 가능성도 동반 |
| Credit Stress Risk | 1.5/10 | 이전 기록 없음 | HY spread, BBB spread, lending standards, financial stress, and business-loan delinquency threshold scores | 낮음: 스프레드와 스트레스 지표 기준으로 급성 신용위기는 아직 제한적 |
| FX Risk | 6.5/10 | 이전 기록 없음 | Weighted USD/KRW level, USD/KRW 3M, DXY, US-Korea policy-rate gap, foreign flows, and trade balance | 중간 이상: USD/KRW 레벨과 한미 금리차가 원화 방어 부담을 높임 |
| Climate Supply Shock Risk | 6.0/10 | 이전 기록 없음 | WTI, natural gas 3M, food/commodity 3M, fertilizer 3M, and GDACS non-green event count | 중간 이상: 에너지 가격과 일부 원자재 변동성이 공급충격 리스크를 남김 |
| Growth Slowdown Risk | 3.8/10 | 이전 기록 없음 | Unemployment, payroll change, jobless claims, 10Y-2Y spread, and lending standards | 중간: 고용은 버티지만 둔화 신호를 계속 확인해야 하는 구간 |
...
| 트리거 | 상태 | 현재값 | 액션 |
|---|---|---|---|
| USD/KRW >= 1500 | 관찰 | 1504.3 (2026-05-26) | 환율 안정 전까지 헤지 비중 유지 |
| Credit stress trigger | 비활성 | 2.74 (2026-05-25) | 주식/ETF 최소 성장 노출 유지 가능 |
| Core inflation >= 3% | 발동 | Core CPI 2.74%, Core PCE 3.2% | 금/은 헤지 유지, 장기 성장주 확대 보류 |
| WTI >= 100 | 관찰 | 112.25 (2026-05-18) | 공급충격 리스크가 남아 헤지 축 유지 |
