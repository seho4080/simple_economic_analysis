...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--raw-dir", default="data/raw/yahoo_kr_etf_backtest")
    parser.add_argument("--output-dir", default="data/processed/backtests/actual_kr_etf_2020-04_to_2026-04")
    parser.add_argument("--report", default="reports/backtests/actual_kr_etf_2020-04_to_2026-04.md")
